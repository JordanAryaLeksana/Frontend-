...
import ParticlesBackground from "../pages/oprec/components/ParticleBG";
...
export default function Section2({ setUploadedFile }: InputUploadProps) {
  ...
  return (
    <div className="w-full h-full m-auto">
      <div className="flex flex-col m-auto justify-center items-center md:items-start sticky z-20">
